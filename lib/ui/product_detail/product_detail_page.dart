                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    _buildSpecItem(
                                      "Features",
                                      "Noise Cancellation, Voice Assistant, Dual Pairing",
                                    ),
                                ...
                                Column(
                                  ...
                                  children: [
                                    _buildReviewItem(
                                      ...
                                      rating: 5,
                                      comment:
                                          "Sound quality is just amazing. Battery backup easily lasts a day. Highly recommended!",
                                    ),
                                    SizedBox(height: 10),
                                    _buildReviewItem(
                                      name: "Priya Verma",
                                      rating: 4,
                                      comment:
                                          "Comfortable to wear for long hours. Mic quality could be better but great value for money.",
                                    ),
                                    SizedBox(height: 10),
                                    _buildReviewItem(
                                      name: "Rahul Singh",
                                      rating: 5,
                                      comment:
                                          "Excellent bass and connectivity. Using for 3 months without any issue. Go for it!",
                                    ),
                                  ],
                                ),
                              ],
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        context.read<CartBloc>().add(
                          AddToCartEvent(
                            productId: int.parse(currModel!.id!),
                            qty: quantity,
                          ),
                        );
                      },
